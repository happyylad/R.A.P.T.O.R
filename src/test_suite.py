...
class RaptorTestSuite:
        ...
        try:
            ...
            for i in range(3):
                ...
                if results[0].boxes is not None:
                    ...
                    test_results.append({'detections': detections, 'high_conf': high_conf})
    ...
    def test_gps_conversion(self):
        ...
        try:
            ...
            test_cases = [
                ...
                (1000, 600, bounds['bottom_right']['lat'], bounds['bottom_right']['lon']),
                (500, 300, 36.4059, -105.57155),
            ]
            
            errors = []
            for pixel_x, pixel_y, expected_lat, expected_lon in test_cases:
                actual_lat, actual_lon = converter.pixel_to_gps(pixel_x, pixel_y, 1000, 600)
    ...
    def generate_test_report(self):
        ...
        print(f"Environment: {'YOLO Available' if YOLO_AVAILABLE else 'YOLO Simulated'}")
        print(f"\n📊 SUMMARY:")
